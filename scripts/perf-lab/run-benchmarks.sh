...
help() {
  ...
  echo "  - .NET 10 SDK (https://dotnet.microsoft.com/download/dotnet/10.0) when running aspnet10"
  echo
  ...
  echo "                                                              Default: 'quarkus3-jvm,quarkus3-leyden,quarkus3-virtual,quarkus3-virtual-leyden,quarkus3-native,spring3-jvm,spring3-leyden,spring3-virtual,spring3-virtual-leyden,spring3-native,spring4-jvm,spring4-leyden,spring4-virtual,spring4-virtual-leyden,spring4-native,aspnet10'"
...
validate_values() {
  ...
  if [[ "$PROFILER" != "none" && " ${RUNTIMES[*]} " == *" aspnet10 "* ]]; then
    echo "!! [ERROR] aspnet10 currently supports --profiler none only!!"
    exit_abnormal
  fi
}
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
  ...
  DEFAULT_RUNTIMES=("quarkus3-jvm" "quarkus3-leyden" "quarkus3-virtual" "quarkus3-virtual-leyden" "quarkus3-native" "spring3-jvm" "spring3-leyden" "spring3-virtual" "spring3-virtual-leyden" "spring3-native" "spring4-jvm" "spring4-leyden" "spring4-virtual" "spring4-virtual-leyden" "spring4-native" "aspnet10")
